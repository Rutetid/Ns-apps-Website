...
const PersonPopup = () => {
	return (
		<div className="absolute top-36 left-[600px] h-80 w-80 rounded-lg  bg-black/10 border border-white border-opacity-20 shadow-md backdrop-blur-md font-poppins">
			...
			<div className="mt-5 ">
				...
				<div className="flex items-center justify-center rounded-lg   border-black">
					<img
						...
						alt=""
						className="mt-2 p-1 h-9 rounded-lg"
					/>
				</div>
			</div>
		</div>
